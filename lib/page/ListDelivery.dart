...
import 'package:adminshop/page/CloseInvoice.dart';
...
class _ListDeliveryState extends State<ListDelivery> {
  ...
  getOrderBoardCash() async {
    ...
    await apiCall.getOrderBoardcastByStatus(shopID, 'DELIVERY').then((value) {
      setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Center(child: Text('ລາຍການສົ່ງສິນຄ້າ')),
      ),
