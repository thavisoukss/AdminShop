...
class ListOrderAccept extends StatefulWidget {
  @override
  _ListOrderAcceptState createState() => _ListOrderAcceptState();
}

class _ListOrderAcceptState extends State<ListOrderAccept> {
  ...
  getOrderBoardCash() async {
    ...
    await apiCall.getOrderBoardcastByStatus(shopID, 'ACCEPTED').then((value) {
      setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Center(child: Text('ລາຍການຍອມຮັບສົ່ງສິນຄ້າ')),
      ),
